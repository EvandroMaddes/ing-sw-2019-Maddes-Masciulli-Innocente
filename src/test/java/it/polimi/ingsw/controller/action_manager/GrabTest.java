...
public class GrabTest {
    ...
    public void adrenalinicGrabTest(){
        ...
        choiceMessage.performAction(controller);
        Event requestMessage = hashMap.get(player1.getUsername()).getToRemoteView();
        Assert.assertEquals(6, ((PositionGrabRequestEvent)requestMessage).getPossibleSquareX().length);
        int[] expectedX = new int[]{0,0,0,1,1,2};
        int[] expectedY = new int[]{0,1,2,0,1,0};
